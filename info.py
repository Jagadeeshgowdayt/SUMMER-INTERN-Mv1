...
PICS = (environ.get('PICS', 'https://graph.org/file/8c04a4dad0afb34dce2c7.jpg')).split()
...
auth_grp = environ.get('AUTH_GROUP','-1001863340529')
AUTH_CHANNEL = int(auth_channel) if auth_channel and id_pattern.search(auth_channel) else None
AUTH_GROUPS = [int(ch) for ch in auth_grp.split()] if auth_grp else None
support_chat_id = environ.get('SUPPORT_CHAT_ID','-1001914868571')
...
HOW_TO_VERIFY = environ.get('HOW_TO_VERIFY', "https://t.me/filmztube_openlink")
VERIFY2_URL = environ.get('VERIFY2_URL', "TinyFy.in")
VERIFY2_API = environ.get('VERIFY2_API', "48c577757243620c64c7b6536fce211fc264e7ad")
SHORTLINK_URL = environ.get('SHORTLINK_URL', 'TinyFy.in')
SHORTLINK_API = environ.get('SHORTLINK_API', '48c577757243620c64c7b6536fce211fc264e7ad')
IS_SHORTLINK = is_enabled((environ.get('IS_SHORTLINK', 'False')), False)
DELETE_CHANNELS = [int(dch) if id_pattern.search(dch) else dch for dch in environ.get('DELETE_CHANNELS', '0').split()]
MAX_B_TN = environ.get("MAX_B_TN", "10")
MAX_BTN = is_enabled((environ.get('MAX_BTN', "True")), True)
PORT = environ.get("PORT", "8080")
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/FILMZ_TUBE')
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1001822634247')).split()]
